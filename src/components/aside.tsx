      ...
      <div className="overflow-y-auto py-4 px-3 bg-gray-50  dark:bg-gray-800  h-screen">
        <ul className="space-y-2">
          ...
          <li className="absolute bottom-2 ">
            ...
            >
              <img
                src="https://avatars.githubusercontent.com/u/58746461?v=4"
                alt=""
                className="rounded-full h-12 w-12"
              />
              <div className="user flex flex-col">
                <span className="ml-3 whitespace-nowrap text-white font-semibold">Carlos David </span>
                <span className="ml-3 whitespace-nowrap text-sm">Sign Up</span>
              </div>
            </a>
          </li>
        </ul>
